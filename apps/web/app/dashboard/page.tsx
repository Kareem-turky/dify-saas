  ...
  return <main className="shell">
    ...
    {summary && current && <>
      ...
      <div className="grid">
        ...
        <div className="item metric"><strong>Latest receipt</strong><p>{summary.latestInvoice ? `${summary.latestInvoice.invoiceNumber} · ${summary.latestInvoice.amountEgp} ${summary.latestInvoice.currency} · ${summary.latestInvoice.status}` : 'لم تصدر فاتورة بعد'}</p>{summary.latestInvoice && <a className="btn secondary" href={`${API_BASE}/billing/invoices/${summary.latestInvoice.id}/receipt`} target="_blank">View receipt</a>}</div>
