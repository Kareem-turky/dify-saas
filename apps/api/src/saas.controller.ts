...
export class SaasController {
  ...
  @Get("admin/readiness") async readiness(@Headers("authorization") authorization?: string) { await this.saas.requireAdmin(authorization); return this.saas.getReadiness({ difyGateway: this.difyGateway.getStatus(), provisioningWorker: this.provisioningWorker.getStatus() }); }
